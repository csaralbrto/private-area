            ...
            <section class="stepBox mt40 mb40">
                ...
                <nav class="stepBox__nav">
                    ...
                    <ul class="stepBox__nav__list">
                        ...
                        {{-- END STEP BOX NAV LIST ITEM --}}
                        {{-- STEP BOX NAV LIST ITEM --}}
                        <li class="stepBox__nav__item desactive_bton disabled " data-stepbox="fotografias-videos">
                ...
                {{-- END STEP BOX NAV --}}
                {{-- STEP BOX CONTAINER --}}
                <form method="post" @if (isset($edit) && $edit == true) action="{{route('paso-paso-edicion-inmobiliaria')}}" @else action="{{route('paso-paso-publicacion-inmobiliaria')}}" @endif class="stepBox__container form form--publish" id="form--publish" enctype="multipart/form-data">
                @csrf
                {{-- STEP BOX CONTENT --}}
                @if(isset($edit) && $edit == true)
                    <input type="hidden" name="edit" id="edit" value="1">
                    <input type="hidden" name="inmuebleId" id="inmuebleId" value={{$inmueble->id}}>
                @elseif(isset($reuse) && $reuse == true)
                <input type="hidden" name="reuse" id="reuse" value="1">
                <input type="hidden" name="inmuebleId" id="inmuebleId" value={{$inmueble->id}}>
                @endif
                @if(isset($credito))<input type="hidden" name="creditoID" id="creditoID" value= {{$credito->id}}>@endif
                    <article class="stepBox__content" data-stepbox="tipo-inmueble">
                        ...
                        <div class="stepBox__content__box pl10 plM0 mb20">
                            ...
                            <article class="form__box form__box--title">
                                ...
                                <?php $selectedvalue=(isset($inmueble)&&!isset($reuse)) ? $inmueble->tipo_inmueble:""  ;
                                $disabled =(isset($inmueble)&&!isset($reuse)) ? 'disabled': '' ?>
                            ...
                            <article class="form__box form__box--title form__box--adjust form__box--multiple mt20">
                                ...
                                <?php $selectedvalue=(isset($inmueble)&&!isset($reuse)) ? $inmueble->uso:"" ?>
                                @if(isset($inmueble)&& !isset($reuse))
                                    @forelse ($para as $key =>$item)
                                        <input type="radio" name="publicarPara" id="para_{{$key}}" class="form__radio" {{ $selectedvalue == $key ? 'checked' : '' }} {{$key==0 || $key==1?' data-pp=vender':''}}  {{$key==2?'data-pp=arrendar':''}}  {{$key==3||$key==4?'data-pp=ambos':''}} value="{{$key}}" required>
                            ...
                            <article class="form__box form__box--title mt20 @if(isset($inmueble->uso)&&($inmueble->uso == 2)) hidden @else @endif" data-pp="vender ambos">
                                ...
                                <input type="text" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->valor_venta}}"@endif name="Tventa" id="publish-a4" class="form__input form__input--line maskM" placeholder="$ Valor venta COP" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title mt20 @if(isset($inmueble->uso)&&($inmueble->uso == 2 || $inmueble->uso == 3 || $inmueble->uso == 4))@else hidden @endif" data-pp="arrendar ambos">
                                <h3 class="form__box__title mb10">$ Valor arriendo:</h3>
                                <input type="text" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->valor_arriendo}}"@endif name="Tarriendo" id="publish-a5" class="form__input form__input--line maskM" placeholder="$ Valor arriendo COP" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            @if(isset($inmueble)&& !isset($reuse))
                                ...
                                <article class="form__box form__box--title mt20" data-bb="si_administracion">
                                    ...
                                    <input type="text"  @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->valor_administracion}}"@endif name="Tadministracion" id="publish-a7" class="form__input form__input--line maskM" placeholder="$ Valor administración COP" required>
                                </article>
                                @else
                                <article class="form__box form__box--title mt20" data-bb="si_administracion">
                                    <h3 class="form__box__title mb10">$ Valor administración:</h3>
                    ...
                    <article class="stepBox__content" data-stepbox="ubicacion">
                        ...
                        <div class="stepBox__content__box pl10 plM0 mb20">
                            ...
                            <article class="form__box form__box--title form__box--50 mt20 w100">
                                ...
                                <?php $selectedvalue=(isset($inmueble)&&!isset($reuse)) ? $inmueble->ciudad:"" ;
                                $disabled =(isset($inmueble)&&!isset($reuse)) ? 'disabled': '' ?>
                            ...
                            <article class="form__box form__box--title form__box--50 mt20">
                                ...
                                <?php $selectedvalue=(isset($inmueble)&&!isset($reuse)) ? $inmueble->localidad:"" ;
                                $disabled =(isset($inmueble)&&!isset($reuse)) ? 'disabled': '' ?>
                            ...
                            <article class="form__box form__box--title form__box--50 mt20 mlA">
                                ...
                                <?php $selectedvalue=(isset($inmueble)&&!isset($reuse)) ? $inmueble->barrio:"";
                                $disabled =(isset($inmueble)&&!isset($reuse)) ? 'disabled': '' ?>
                            ...
                            <article class="form__box form__box--title mt20">
                                ...
                                <input type="text" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->direccion}}" @else placeholder="Direccion"@endif name="Udireccion" id="publish-b3" class="form__input form__input--line @if(isset($inmueble)&& !isset($reuse)) disabled @endif direccionChange" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title mt20 @if(isset($inmueble)&& !isset($reuse))hidden @endif">
                            ...
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title mt20 @if(isset($inmueble)&& !isset($reuse))  @else hidden @endif" data-project="existing">
                            ...
                            <article class="form__box form__box--title form__box--50 mt20">
                                ...
                                <input type="text" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->longitude}}" disabled @endif name="Ulongitude" id="publish-b4" class="form__input form__input--line" placeholder="Longitud">
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title form__box--50 mt20 mlA">
                                <label class="form__box__title dB mb10" for="publish-b5">Latitud:</label>
                                <input type="text" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->latitude}}" disabled @endif name="Ulatitude" id="publish-b5" class="form__input form__input--line" placeholder="Latitud">
                            </article>
                            {{-- END FORM FILTER BOX --}}
                        </div>
                    </article>
                    ...
                    <article class="stepBox__content" data-stepbox="caracteristicas">
                        ...
                        <div class="stepBox__content__box pr10 prM0 mb20">
                            ...
                            <article class="form__box form__box--title mt20">
                                ...
                                <textarea type="text"  class="form__textarea form__textarea--line" name="Cdescription" id="publish-c1" required>@if(isset($inmueble)&& !isset($reuse)){{$inmueble->descripcion}}@endif</textarea>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                        </div>
                        <div class="stepBox__content__box pl10 plM0 mb20">
                            ...
                            <article class="form__box form__box--title form__box--50">
                                ...
                                <input type="number"  @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->medida_apartamento}}"@endif name="Cmetros" id="publish-c2" class="form__input form__input--line" placeholder="Metros Cuadrados" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title form__box--50 mlA">
                                ...
                                <input type="number" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->n_garages}}"@endif name="Cgarages" id="publish-c3" class="form__input form__input--line" placeholder="Garajes" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title form__box--50 mt20">
                                <label class="form__box__title dB mb10" for="publish-c4">Habitaciones:</label>
                                <input type="number" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->n_habitaciones}}"@endif name="Chabitaciones" id="publish-c4" class="form__input form__input--line" placeholder="Habitaciones" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title form__box--50 mt20 mlA">
                                <label class="form__box__title dB mb10" for="publish-c5">Baños:</label>
                                <input type="number" @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->n_banos}}"@endif name="Cbanos" id="publish-c5" class="form__input form__input--line" placeholder="Baños" required>
                            </article>
                            {{-- END FORM FILTER BOX --}}
                            {{-- FORM FILTER BOX --}}
                            <article class="form__box form__box--title form__box--50 mt20">
                                    <label class="form__box__title dB mb10" for="publish-c11">Número de piso:</label>
                                    <input type="number" name="Cpiso" id="publish-c11" class="form__input form__input--line" placeholder="Número de piso" required @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->n_piso}}"@endif>
                                </article>
                                {{-- END FORM FILTER BOX --}}
                                {{-- FORM FILTER BOX --}}
                                <article class="form__box form__box--title form__box--50 mt20 mlA">
                                    <label class="form__box__title dB mb10" for="publish-c12">Estrato:</label>
                                    {{-- <input type="number" name="Cestrato" id="publish-c12" class="form__input form__input--line" placeholder="Estrato" required @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->estrato}}"@endif> --}}
                                    <select name="Cestrato" id="" class="select" required>
                                        <option value="" selected>Seleccionar</option>
                                        <option value="3" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->estrato ==3? 'selected':''}} @endif>3</option>
                                        <option value="4" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->estrato ==4? 'selected':''}} @endif>4</option>
                                        <option value="5" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->estrato ==5? 'selected':''}} @endif>5</option>
                                        <option value="6" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->estrato ==6? 'selected':''}} @endif>6</option>
                                    </select>
                                </article>
                                {{-- END FORM FILTER BOX --}}
                                {{-- FORM FILTER BOX --}}
                                <article class="form__box form__box--title form__box--50 mt20">
                                    ...
                                    <select name="Cantiguedad" class="select" id="" {{$disabled}}>
                                        <option value="1" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==1? 'selected':''}} @else selected @endif>Todas las opciones</option>
                                        <option value="2" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==2? 'selected':''}} @endif >Remodelado</option>
                                        <option value="3" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==3? 'selected':''}} @endif >Entre 0 y 5 años</option>
                                        <option value="4" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==4? 'selected':''}} @endif >Entre 5 y 10 años</option>
                                        <option value="5" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==5? 'selected':''}} @endif >Entre 10 y 20 años</option>
                                        <option value="6" @if(isset($inmueble)&& !isset($reuse)) {{$inmueble->antiguedad ==6? 'selected':''}} @endif >Entre 20 y 30 años</option>
                                    </select>
                                    {{-- <input type="number" name="Cantiguedad" id="publish-c13" class="form__input form__input--line" placeholder="Antigüedad" required @if(isset($inmueble)&& !isset($reuse))value="{{$inmueble->antiguedad}}"@endif> --}}
                                </article>
                                {{-- END FORM FILTER BOX --}}
                                {{-- FORM FILTER BOX --}}
                                <article class="form__box form__box--title form__box--50 mt20 mlA">
                    ...
                    <article class="stepBox__content" data-stepbox="fotografias-videos">
                        ...
                        <div class="stepBox__content__box pl10 plM0 mb20 fallback">
                            {{-- FORM GROUP --}}
                            {{-- <a href="#" class="exex">dfgdfhdfh</a> --}}
                            <div class="w100 form__group form__group--dropzone  @if(isset($credito)){{$credito->tipo_credito ==5?'':'hidden'}}@endif">
                                {{-- FORM FILTER BOX --}}
                                <article class="form__box form__box--title mb20 @if(isset($credito) && isset($edit)){{$credito->tipo_credito ==5?'hidden':''}}@endif" data-project="new">
                                    <h3 class="form__box__title mb10">Imagen principal del Inmueble:</h3>
                                    <div class="form__pseudo">
                                        ...
                                        <span class="form__pseudo__message"></span>
                                    </div>
                                </article>
                                ...
                                {{-- <h3 class="form__box__title mb10">Imagenes del Inmueble:</h3> --}}
                                <article class="form__box form__box--title">
                                    {{-- DROPZONE --}}
                                    <div class="dropzone @if(isset($credito) && isset($edit)){{$credito->tipo_credito ==5?'hidden':''}}@endif" enctype="multipart/form-data">
                    ...
                    {{-- STEP BOX CONTENT --}}
                    {{-- STEP BOX CONTENT --}}
                    <article class="stepBox__content @if(isset($reuse)) hide @endif" data-stepbox="visibilidad">
                        ...
                        <div class="stepBox__content__box pl10 plM0 mb20">
                            ...
                            @else
                                <article class="form__box form__box--title form__box--50">
                                    <input type="radio" name="visibilidad" id="publish-a12a" class="form__radio form__radio--switch" data-switch="cliente" value="2" @if(isset($credito) && ($credito->tipo_credito==5 || $credito->tipo_credito==4)) disabled @endif>
                                    <label for="publish-a12a" class="form__label form__label--radio form__label--inline ttU lGray semiBold text text--xs">Yo elijo la segmentacion</label>
                                </article>
                            @endisset
                            @isset($inmueble)
                            ...
                            @if(isset($inmueble) && !isset($reuse))
                                @if ($inmueble->visibilidad == 2)
                                    <div class="form__switchBox " data-switch="cliente">
                                        ...
                                        <article class="form__box form__box--title form__box--middle form__box--adjust form__box--multiple mt20 mlM0">
                                                <select id="publish-a13" class="select disabled" name="VedadD" disabled>
                                                    @switch($vedadD)
                                                    @case(2)
                                        ...
                                        <article class="form__box form__box--title form__box--middle form__box--adjust form__box--multiple mt20 mlM0">
                                                <select id="publish-a14" class="select disabled" name="VedadH" disabled>
                                                        @switch($vedadH)
                                                        @case(2)
                                                            <option value="2" selected="selected">18</option>
                                                            @break
                                ...
                                <div class="form__switchBox" data-switch="cliente">
                                    ...
                                    <article class="form__box form__box--title form__box--adjust form__box--multiple mt20 mlM0 w100">
                                        <h3 class="w100 form__box__title mb10 ml0">Cómo mas te gustaria que tu inmueble fuera visible:</h3>
                    ...
                    {{-- <button class="btn btn--gradient ttU mt10 mlA mrMA stepBox__next" id="publics">Pblicar</button> --}}
                </form>
