...
<header class="main-header">
    <script>
        jQuery(document).ready(function($){
            ...
            let actionName = 'destacado_leer_mas';
            let actionEnd = actionForm.indexOf(actionName);
            /*console.log(actionEnd);
            if(actionEnd !== -1){
                setTimeout(function(){ $('.input-group.file-caption-main').first().after('<span style="color:red">*Las imágenes deben tener una proporción de 500*600 aprox.*</span>');}, 500);
            }*/
        });
    </script>
    <!-- Logo -->
